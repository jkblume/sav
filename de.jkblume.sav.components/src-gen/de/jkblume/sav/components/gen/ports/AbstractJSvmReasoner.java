...
public abstract class AbstractJSvmReasoner
		implements
			IPort<ILearningProcess>,
			INotifyPropertyChanged,
			ILearningProcess {

	private String name;
	private boolean isActive = true;
	protected ILearningProcess base;
	...
	public AbstractJSvmReasoner(String name) {
		this.name = name;
	}
	...
	@Override
	public ILearningProcess getBase() {
		return base;
	}

	@Override
	public void setBase(ILearningProcess base) {
		this.base = base;
	}
