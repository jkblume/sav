...
public abstract class AbstractPullReasoner extends AbstractComponent implements INotifyPropertyChanged, IReasoner {
	...
	public AbstractPhysicalProcess getSmlConfiguration() {
		return (AbstractPhysicalProcess) getSharedMemory().getValue(AbstractPullReasoner.class, "smlConfiguration");
	}
	...
	public void setSmlConfiguration(AbstractPhysicalProcess smlConfiguration) {
		...
		getSharedMemory().setValue(AbstractPullReasoner.class, "smlConfiguration", smlConfiguration);
		notifyPropertyChanged(this, "smlConfiguration", oldValue, smlConfiguration);
	}

	public Event getLastEvent() {
		return (Event) getSharedMemory().getValue(AbstractPullReasoner.class, "lastEvent");
	}

	public void setLastEvent(Event lastEvent) {
		Event oldValue = getLastEvent();
		getSharedMemory().setValue(AbstractPullReasoner.class, "lastEvent", lastEvent);
