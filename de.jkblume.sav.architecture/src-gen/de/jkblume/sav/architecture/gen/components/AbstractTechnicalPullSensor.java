...
@Component(name = "TechnicalPullSensor", appName = "SavMetaArchitecture", appPackageName = "de.jkblume.sav.architecture", componentTypeName = "TechnicalPullSensor", typeArchitectureName = "SavMetaArchitecture", typeArchitectureNamespace = "de.jkblume.sav.architecture")
public abstract class AbstractTechnicalPullSensor extends AbstractComponent implements INotifyPropertyChanged, ISensor {
	...
	public AbstractTechnicalPullSensor(String name) {
		super(name);
	}

	public AbstractPhysicalProcess getSmlConfiguration() {
		return (AbstractPhysicalProcess) getSharedMemory().getValue(AbstractTechnicalPullSensor.class,
				"smlConfiguration");
	}
	...
	public void setSmlConfiguration(AbstractPhysicalProcess smlConfiguration) {
		...
		getSharedMemory().setValue(AbstractTechnicalPullSensor.class, "smlConfiguration", smlConfiguration);
		notifyPropertyChanged(this, "smlConfiguration", oldValue, smlConfiguration);
	}

	public Event getLastEvent() {
		return (Event) getSharedMemory().getValue(AbstractTechnicalPullSensor.class, "lastEvent");
	}

	public void setLastEvent(Event lastEvent) {
		Event oldValue = getLastEvent();
		getSharedMemory().setValue(AbstractTechnicalPullSensor.class, "lastEvent", lastEvent);
