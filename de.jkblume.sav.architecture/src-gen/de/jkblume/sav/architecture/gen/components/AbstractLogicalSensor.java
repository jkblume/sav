...
public abstract class AbstractLogicalSensor extends AbstractComponent implements INotifyPropertyChanged, ISensor {
	...
	public Event getCurrentEvent() {
		return (Event) getSharedMemory().getValue(AbstractLogicalSensor.class, "currentEvent");
	}

	public void setCurrentEvent(Event currentEvent) {
		Event oldValue = getCurrentEvent();
		getSharedMemory().setValue(AbstractLogicalSensor.class, "currentEvent", currentEvent);
